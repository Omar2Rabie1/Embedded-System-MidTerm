...
const QUESTIONS = [
  ...
  {
    question:
      "Computing systems are divided into two types: General purpose and Specific purpose.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "Which of the following is an example of a specific-purpose system?",
  ...
  {
    question:
      "Which of the following is not a constraint for embedded systems?",
  ...
  {
    question:
      "Which of the following is not a component connected on a breadboard?",
  ...
  },
  {
    ...
    options: [
      "To connect electronic components for various projects",
      "To bake bread",
  ...
  {
    question:
      "A System Board is used to connect electronic components such as wires, processors, memory, and I/O preferences.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  },
  {
    ...
    options: [
      "A single chip combining many high-level function elements",
      "A separate component mounted to a motherboard",
  ...
  {
    question:
      "An Integrated Circuit (IC) combines many or all high-level function elements of an electronic device onto a single chip.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "Which of the following can be edited during the system's design phase?",
    options: ["System board", "System on Chip"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  },
  {
    ...
    options: [
      "Baking bread",
      "Timer, delay, and pulse generation applications",
      "Writing software code",
    ],
    correctAnswer: 1,
    userAnswer: null,
  ...
  {
    question:
      "The 555 timer IC is used in many applications of timer, delay, and pulse generation.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "The 555 timer IC is not popular due to its flexibility and price.",
    options: ["True", "False"],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "What is the role of the CPU in a system with multiple microprocessors?",
  ...
  {
    question:
      "The CPU is the master processor, and other microprocessors like GPU and DSP are secondary processors.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "If the system has many microprocessors, so the primary one is the CPU",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "MPU (Microprocessor Unit) is a part of MCU (Microcontroller Unit)",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  },
  {
    ...
    options: [
      "Deal with complex computations",
      "Primary processor",
      "Memory unit",
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      "Decrease load on the primary processor",
      "Increase load on the primary processor",
  ...
  {
    question:
      "For computations like (Fourier transform), ………. deal with the computations.",
    options: ["GPU", "DSP", "CPU"],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  ...
  },
  {
    ...
    options: [
      "Integrate multiple components into a single chip",
      "Serve as a primary processor",
      "Manage memory",
    ],
    correctAnswer: 0,
    userAnswer: null,
  ...
  },
  {
    ...
    options: [
      "BareMetal SW and OS Applications",
      "Cloud Computing and OS Applications",
      "BareMetal SW and Cloud Computing",
    ],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "Which type of application requires a microcontroller with high performance?",
  ...
  {
    question:
      "OS Applications require a microcontroller with high performance.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  },
  {
    ...
    options: [
      "Because we need a microcontroller with high performance",
      "Because we need a microcontroller with low performance",
      "Because we need a microcontroller with medium performance",
    ],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "Which of the following is not a reason for SoC dealing with OS Applications?",
  ...
  {
    question:
      "SoC deals with OS Applications because we need a microcontroller with high performance.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "SoC deals with Non BareMetal SW because we need a microcontroller with high performance.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "SoC deals with BareMetal SW because we need a microcontroller with high performance.",
    options: ["True", "False"],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "High performance is a reason for SoC dealing with OS Applications.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "Which of the following is not a type of application for embedded systems?",
    options: ["BareMetal SW", "OS Applications", "Cloud Computing"],
    correctAnswer: 2,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "BareMetal SW not require a microcontroller with high performance.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  },
  {
    ...
    options: [
      "Not highly performance microcontroller",
      "High performance microcontroller",
      "Medium performance microcontroller",
    ],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "Which of the following is not a component of a computing system?",
  ...
  {
    question:
      "Which of the following is not a part of the instruction life cycle?",
  ...
  {
    question:
      "The role of the processor includes fetching, decoding, and executing instructions.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "What does the CPU reference before fetching an instruction from memory?",
    options: [
      "Program counter",
  ...
  {
    question:
      "The CPU references the instruction register before fetching an instruction from memory.",
    options: ["True", "False"],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "After fetching an instruction, the program counter is increased by 1.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "What is the role of the program counter in the instruction life cycle?",
    options: [
      "To contain the memory address of the next instruction",
  ...
  {
    question:
      "What is the next instruction referred to in the instruction life cycle?",
    options: [
      "The instruction to be executed after the current one",
  ...
  },
  {
    ...
    options: [
      ...
      "Decreases the program counter by 1",
  ...
  {
    question:
      "The next instruction is the one to be executed after the current one.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "After the CPU fetches the instruction, it increases the program counter by 1 so it points to the next instruction in the program's sequence.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "After the CPU fetches the instruction, it increases the program counter by 1 so it points to the Current instruction in the program's sequence.",
    options: ["True", "False"],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "After fetching an instruction, the CPU decreases the program counter by 1.",
    options: ["True", "False"],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  ...
  },
  {
    ...
    options: [
      "Fetch from memory to register inside CPU",
      "Fetch directly from the Bus",
      "Fetch from I/O devices",
    ],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "The Instruction Decoder (ID) decodes the instruction to send it to execution.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  },
  {
    ...
    options: [
      "Understanding the instruction to send it to execution",
  ...
  {
    question:
      "What signal does the CU send to the ALU after decoding the instruction?",
    options: [
      "Add, Subtract, etc.",
      "Fetch, Decode, Execute",
      "Store, Retrieve, Delete",
  ...
  {
    question:
      "What are the two pieces of information needed to decode the instruction?",
    options: [
      "Instruction Set and Instruction Format",
      "Instruction Code and Instruction Address",
      "Instruction Data and Instruction Type",
    ],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "Decoding the instruction means understanding it to send it to execution.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "The CU sends a signal to the ALU after decoding the instruction.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "The two pieces of information needed to decode the instruction are Instruction Code and Instruction Address.",
    options: ["True", "False"],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "The two pieces of information needed to decode the instruction are Instruction Set and Instruction Format.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "What is the role of the Control Unit (CU) in the instruction life cycle?",
    options: [
  ...
  },
  {
    ...
    options: [
      "Any empty register in general purpose registers",
      "Accumulator",
      "Memory",
    ],
    correctAnswer: 0,
  ...
  {
    question:
      "In old processors, the results of the ALU are stored in the Accumulator.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "In new microprocessors, the results of the ALU are stored in memory.",
    options: ["True", "False"],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  },
  {
    ...
    options: [
      "To understand that the instruction contains an ADD operation",
      "To store the instruction in memory",
  ...
  {
    question:
      "What does the Instruction Decoder (ID) do after decoding the instruction?",
    options: [
      "Sends a signal to the ALU",
      "Stores the instruction in memory",
  ...
  {
    question:
      "The Instruction Set helps understand that the instruction contains an ADD operation.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "The Instruction Decoder (ID) stores the instruction in memory after decoding it.",
    options: ["True", "False"],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  },
  {
    ...
    options: [
      "Because assembly language varies depending on different microprocessors",
      "Because C language is faster",
      "Because assembly language is easier to understand",
    ],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "Using assembly language is better than using C language because it is faster.",
    options: ["True", "False"],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  },
  {
    ...
    options: [
      "The compiler converts it into many add operations",
  ...
  {
    question:
      "If the instruction is * in Microprocessor 1, the compiler converts it into many add operations.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "Each microprocessor has different machine language to understand.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "Microprocessors, Microcontrollers, and SoCs are examples of ICs.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "Application-Specific UI systems contain standard, general-purpose interfaces.",
    options: ["True", "False"],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "The design process of an embedded system begins with defining requirements.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "Functional requirements include cost and performance constraints.",
    options: ["True", "False"],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "Battery-powered systems usually require strict power constraints.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  },
  {
    ...
    options: [
      "A rough design document for programmers",
      "A contract between the customer and the architects",
  ...
  },
  {
    ...
    options: [
      "Complex and difficult for customers to understand",
      "Very short and vague",
      "Precise and understandable for verification",
      "Only written by programmers",
    ],
    correctAnswer: 2,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "Which of the following is not part of a GPS system specification?",
    options: [
      "Data from GPS satellites",
      "Internal CPU temperature logs",
      "Map data",
  ...
  },
  {
    ...
    options: [
      "Only the software components",
      "Only the hardware components",
      "Major hardware and software components",
      "Only data flow between satellites",
    ],
    correctAnswer: 2,
    userAnswer: null,
    isCorrect: null,
  },
  {
    ...
    options: [
      "Software vs. weather conditions",
      "Hardware vs. software",
      "Map data vs. screen brightness",
      "Customer vs. satellite",
    ],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "In the GPS moving map system, which component converts map data into pixels?",
  ...
  {
    question:
      "Which component stores the image before it appears on the screen?",
  ...
  {
    question:
      "In the software architecture, the database search module receives input from:",
  ...
  },
  {
    ...
    options: [
      "Update or refresh map data periodically",
      "Draw pixel colors",
      "Replace the GPS signal",
  ...
  },
  {
    ...
    options: [
      ...
      "Bugs often appear only after integrating components",
      "It replaces testing",
      "It eliminates the need for specification",
    ],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  },
  {
    ...
    options: [
      "An independent device with built-in memory",
      "A general-purpose device requiring external memory",
      "Designed only for GPS applications",
      "Always faster than a microcontroller",
    ],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  },
  {
    ...
    options: [
      "A dependent device needing external chips",
      "A general-purpose device",
      "An independent device with built-in memory and peripherals",
      "Only used in laptops",
    ],
    correctAnswer: 2,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "Which of the following is NOT a component of the GPS hardware architecture?",
  ...
  {
    question:
      "PSW is a set of flags; each flag is a bit and has a specific function.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "Instruction Register (IR): stores instruction inside it, after fetch from memory.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "Accumulator (ACC): store results from ALU temporarily- nowadays it is unavailable",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "Program Counter (PC) Placed in ROM and Hold the address(location) of next instruction",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "Stack Pointer (SP) It is a small register that stores the memory address of the last data element added to the stack.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "The assembly language varies depending on different microprocessors.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "A stack is a special register in a computer processor that contains the memory address(location) of the next program instruction to be executed.",
    options: ["True", "False"],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "........... is a hardware device that takes the input from the environment and gives it to the system by converting it.",
  ...
  {
    question:
      ".............is a device that converts the electrical signals into the physical events. It takes the input from the system and gives output to the environment",
    options: ["Actuator", "Sensor"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "Sensors takes the input from the system and gives output to the environment.",
    options: ["True", "False"],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "............used to connect electronic components, such as wires, and processor, memory, and I/O preferences, to conduct various projects.",
    options: ["SoC", "SB"],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "Any computing system must consist of three main things: Processor, Memory, and I/O.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "General-purpose computing systems can run multiple applications on the same hardware resources.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "Which type of computing system is used for a single purpose, like a fridge or microwave?",
  ...
  {
    question:
      "Embedded systems must have constraints in power, cost, speed, and size.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  },
  {
    ...
    options: [
      ...
      "General purpose and Hybrid purpose",
      "Specific purpose and Hybrid purpose",
    ],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  },
  {
    ...
    options: [
      "A processor in the computing system",
      "A type of memory",
  ...
  {
    question:
      "the assembly language will vary depending on different microprocessors.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "What are the two main types of Instruction Set Architecture (ISA)?",
  ...
  },
  {
    ...
    options: [
      "To convert complex instructions into simpler ones",
      "To convert simple instructions into complex ones",
  ...
  },
  {
    ...
    options: [
      "They have a smaller number of instructions compared to RISC.",
      "They require simpler compilers compared to RISC.",
      "They execute instructions faster than RISC.",
      "They are more power-efficient than RISC.",
    ],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "What is the primary difference between RISC and CISC ISAs in terms of instruction complexity?",
    options: [
      "RISC uses complex instructions, while CISC uses simple instructions.",
      "RISC uses fixed-length instructions, while CISC uses variable-length instructions.",
      "RISC uses less instructions, while CISC uses many instructions.",
      "RISC uses more addressing modes than CISC.",
    ],
    correctAnswer: 2,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "RISC ISAs have a larger number of instructions compared to CISC ISAs.",
    options: ["True", "False"],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "RISC ISAs rely on hardware for instruction execution, while CISC ISAs rely on software.",
    options: ["True", "False"],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "RISC ISAs are more suitable for applications with limited memory resources.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "RISC needs a strong compiler to convert complex instructions into simpler ones.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "The Instruction Decoder (ID) is responsible for executing the instruction.",
    options: ["True", "False"],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "The two ways for ID manufacturing are Hard-Wired and Memory-Mapped.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  },
  {
    ...
    options: [
      "Consists of a set of logic gates",
      "Stores instructions in memory",
      "Takes time to search for instructions",
    ],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  },
  {
    ...
    options: [
      "Because it needs less number of instructions",
      "Because it is high performance",
  ...
  {
    question:
      "RISC is used in embedded systems because it is high performance.",
    options: ["True", "False"],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  },
  {
    ...
    options: [
      ...
      "General Purpose Registers (GPR) and Specific Purpose Registers (SPR)",
      "General Purpose Registers (GPR) and Special Functions Registers (SFR)",
    ],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "There are two types of Register files: General Purpose Registers (GPR) and Special Purpose Registers (SPR).",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "Program instructions are stored in General Purpose Registers (GPR).",
    options: ["True", "False"],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  ...
  },
  {
    ...
    options: [
      "To store temporary data in a LIFO manner",
      "To store instructions permanently",
      "To execute instructions",
    ],
    correctAnswer: 0,
  ...
  {
    question:
      "The Stack Pointer (SP) stores the memory address of the last data element added to the stack.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  },
  {
    ...
    options: [
      "To store results from the ALU temporarily",
      "To store instructions permanently",
      "To execute instructions",
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      "To store instructions after fetching from memory",
      "To store data temporarily",
      "To execute instructions",
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      "To store flags representing the status of the last ALU operation",
      "To store instructions permanently",
      "To execute instructions",
    ],
    correctAnswer: 0,
  ...
  {
    question:
      "The Instruction Register (IR) stores instructions after fetching from memory.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "What is the role of the Program Counter (PC) in jump instructions?",
    options: [
      "To point to a new address in memory",
  ...
  },
  {
    ...
    options: [
      "To subtract 1 from a register or memory location",
      "To add 1 to a register or memory location",
      "To multiply a register or memory location by 2",
    ],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "The Program Counter (PC) points to a new address in memory in jump instructions.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "The increment instruction (INC) subtracts 1 from a register or memory location.",
    options: ["True", "False"],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "What is the role of the increment instruction (INC) in certain processor designs?",
    options: [
      "To add 1 to a register without invoking the ALU",
      "To subtract 1 from a register without invoking the ALU",
      "To multiply a register by 2 without invoking the ALU",
    ],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "What is the role of specialized hardware in certain processor designs?",
    options: [
      "To perform simple operations like incrementing a register without invoking the ALU",
      "To perform complex operations like multiplication without invoking the ALU",
      "To store data temporarily",
    ],
    correctAnswer: 0,
    userAnswer: null,
  ...
  {
    question:
      "The increment instruction (INC) adds 1 to a register without invoking the ALU in certain processor designs.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "Specialized hardware performs simple operations like incrementing a register without invoking the ALU in certain processor designs.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "The ALU performs simple operations like incrementing a register in certain processor designs.",
    options: ["True", "False"],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "What is the width of the memory register in an 8-bit architecture?",
  ...
  {
    question:
      "What is the maximum size of operands in the ALU in an 8-bit architecture?",
    options: ["8 bits", "16 bits", "32 bits"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "The width of the memory register in an 8-bit architecture is 16 bits.",
    options: ["True", "False"],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "The maximum size of operands in the ALU in an 8-bit architecture is 8 bits.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "What is the solution if the two operands are larger than 8 bits in an 8-bit architecture?",
  ...
  {
    question:
      "Slicing is the solution if the two operands are larger than 8 bits in an 8-bit architecture.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  },
  {
    ...
    options: [
      "The time it takes to read or write on memory",
      "The time it takes to execute instructions",
      "The time it takes to perform arithmetic computations",
    ],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  },
  {
    ...
    options: [
      "It stores multiple bits of data",
      "It decides when to store data",
      "It deletes data",
  ...
  },
  {
    ...
    options: [
      "Data bus, power bus, control bus",
      "Data bus, address bus, control bus",
      "Data bus, signal bus, control bus",
      "Data bus, voltage bus, control bus",
    ],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  },
  {
    ...
    options: [
      "To transfer data",
      "To determine the location in memory",
  ...
  {
    question:
      "The address bus determines the location in memory that the processor will read from or write to.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  },
  {
    ...
    options: [
      ...
      "The contents read from or written to the memory location",
      "The control signals",
      "The power supply",
    ],
    correctAnswer: 1,
  ...
  {
    question:
      "The control bus indicates whether the operation is a read or a write.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  },
  {
    ...
    options: [
      ...
      "The number of data bits transferred at once",
  ...
  },
  {
    ...
    options: [
      "The voltage level",
      "The power consumption",
      "The amount of data transferred at once",
      "The length of the bus",
    ],
    correctAnswer: 2,
    userAnswer: null,
  ...
  },
  {
    ...
    options: [
      "The bus has 8 wires",
      "The bus has 16 wires",
      "The bus can transfer 32 bits of data at once",
      "The bus can transfer 64 bits of data at once",
    ],
    correctAnswer: 2,
    userAnswer: null,
    isCorrect: null,
  },
  {
    ...
    options: [
      "The bus has 8 wires",
      "The bus has 16 wires",
      "The bus can transfer 32 bits of data",
      "The bus can transfer 64 bits of data at once",
    ],
    correctAnswer: 3,
    userAnswer: null,
  ...
  {
    question:
      "A 32-bit bus size means the bus can transfer 32 bits of data at once.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "A 64-bit bus size means the bus can transfer 32 bits of data at once.",
    options: ["True", "False"],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  ...
  },
  {
    ...
    options: [
      "Read operation is just reading",
      "Write operation is just writing",
      "Read operation increases voltage",
      "Write operation decreases current",
    ],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "How can memory be organized if you have only 4K memory but need 16K?",
    options: [
      "Increase voltage",
      "Decrease current",
      "Connect four 4K memories",
      "Generate heat",
    ],
    correctAnswer: 2,
    userAnswer: null,
  ...
  {
    question:
      "The three key advantages of memory are capacity, speed, and organization.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "A port in a microcontroller allows it to deal with the external world.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  },
  {
    ...
    options: [
      "Because of the components it consists of",
      "Because it uses more power",
      "Because it generates more heat",
  ...
  },
  {
    ...
    options: [
      "They lose capacitance over time",
  ...
  {
    question:
      "A refreshment circuit is needed to prevent charge leakage in DRAM.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  },
  {
    ...
    options: [
      "Because DRAM has higher priority to access memory than CPU",
      "Because DRAM uses more power",
      "Because DRAM generates more heat",
      "Because DRAM is smaller",
    ],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  },
  {
    ...
    options: [
      "High cost, low density, high power consumption",
      "Low cost, high density, low power consumption",
      "High cost, high density, high power consumption",
      "Low cost, low density, low power consumption",
    ],
    correctAnswer: 1,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "DRAM is slower than SRAM because it has higher priority to access memory than CPU.",
    options: ["True", "False"],
    correctAnswer: 0,
    userAnswer: null,
    isCorrect: null,
  ...
  {
    question:
      "What type of memory does not retain data when power is disconnected?",
    options: [
      "Non-volatile memory",
      "Hybrid memory",
      "Volatile memory",
